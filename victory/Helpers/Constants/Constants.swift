...
class Constants {
    static let arrayOfPraktikum = [
        ...
        Praktikum (nama: "Gerak Parabola", gambar: #imageLiteral(resourceName: "gravity_gray"), kelas: .k10, mataPelajaran: .fisika, subtitleMateri: "Materi: Gerak", pertanyaanQuiz: [
            Question(q: "apakah saya cantik?", a: ["ya", "sangat", "betul", "tepat"], correctAnswer: "ya", solusi: "saya memang cantik")
        ]),
        Praktikum (nama: "Gerak Parabola", gambar: #imageLiteral(resourceName: "angle"), kelas: .k10, mataPelajaran: .kimia, subtitleMateri: "Materi: Gerak", pertanyaanQuiz: [
            Question(q: "apakah saya cantik?", a: ["ya", "sangat", "betul", "tepat"], correctAnswer: "ya", solusi: "saya memang cantik")
        ])
    ]
}
